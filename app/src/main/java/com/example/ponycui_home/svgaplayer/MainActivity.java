...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            File cacheFile = new File(getCacheDir(), "http");
            HttpResponseCache.install(cacheFile, 10 * 1024 * 1024);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    void setupData() {
        ...
        this.items.add(new SampleItem("Animation With Test", new Intent(this,
                TestActivity.class)));
    }
